...
const Card = ({ title, description, imageSrc, link, pdfPath1}) => {
  return (
	<Flex direction="column"  w="550px"  bg="white" color="black" borderRadius="lg" overflow="hidden" boxShadow="md" _hover={{ boxShadow: "lg", textDecoration: "none" }}> {/* Changed to Flex, added overflow */}
	<Box >
	<Image src={imageSrc} alt={title} objectFit="cover"  w="auto" h="500px" loading="lazy" /></Box>
